...
<script language="javascript">	
	...
	function closUser(){
		document.all("wm.depManagerSignUsers").value="";
	...
	function showChoiceUser(){
		...
		<form action="/oa/sendFileAuditAction.action" method="post">
			<input type="hidden" name="wm.submitFlag" value="saveDepManagerSign">
			...
			<table border=1>
				<tr>
					<td colspan="4" align="center">请填写发文申请单的部门领导会签记录</td>
				</tr>
				<tr>
					<td>审核结果</td>
					<td>
						同    意：<input type="radio" name="arm.auditResult" value="dmSignOk">
						<br>
						不同意：	<input type="radio" name="arm.auditResult" value="dmSignNot">
					</td>
					<td>审核描述</td>
					<td>
